...
| [RFC-0005](./0005-nac-agent-integration.md) | NAC 云端会务 Agent 接入会务系统对接模式 | implemented | P1 | requires RFC-0002, RFC-0003, RFC-0004；覆盖 meeting_assistant artifact、NAC hack-8 项目配置、FastAPI 运行上下文、幂等/状态版本和 trace 验收 |
