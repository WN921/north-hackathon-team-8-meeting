...
| [RFC-0005](./0005-nac-agent-integration.md) | NAC Agent 集成会务系统对接模式 | draft | P1 | requires RFC-0001, RFC-0002, RFC-0003, RFC-0004；覆盖实际 meeting_assistant artifact、NAC 项目配置、FastAPI 工具调用和 trace 验收 |
